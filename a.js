...
function showWeatherReport(weather) {
    ...
    if (weatherType.textContent == 'Clear') {
        ...
        icon.innerHTML = `<img src="sunnyy.svg" alt="">`
        
        

    } else if (weatherType.textContent == 'Clouds') {
        document.body.style.backgroundImage = "url('cloud1.jpg')";
        icon.innerHTML = `<img src="/cloudy.svg" alt="">`
        ...
        icon.innerHTML = `<img src="hazee.svg" alt="">`
        

    } else if (weatherType.textContent == 'Rain') {

        document.body.style.backgroundImage = "url('rain2.jpg')";
        icon.innerHTML = `<img src="rainy.svg" alt="">`
        

    } else if (weatherType.textContent == 'Snow') {

        document.body.style.backgroundImage = "url('snow2.jpg')";
        icon.innerHTML = `<img src="snow.svg" alt="">`
        

    } else if (weatherType.textContent == 'Thunderstorm') {

        document.body.style.backgroundImage = "url('thunderstorm.jpg')";
        icon.innerHTML = `<img src="thunderstorm.jpg" alt="">`
